...
class StateManager {
  ...
  loadState() {
    try {
      ...
      const u = data.upload_stats || {};
      if (u.success    !== undefined) this.uploadStats.success    = u.success;
      if (u.failed     !== undefined) this.uploadStats.failed     = u.failed;
      if (u.totalBytes !== undefined) this.uploadStats.totalBytes = u.totalBytes;
  ...
  updateUploadStats(updates) {
    Object.assign(this.uploadStats, updates);
  }
